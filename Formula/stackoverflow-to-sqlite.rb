class StackoverflowToSqlite < Formula
  include Language::Python::Virtualenv

  desc "Save all the contributions for a StackOverflow user to a SQLite database."
  ...
  test do
    assert_match "Error: Missing argument 'USER_ID'.", shell_output("#{bin}/universal-test-runner")
  end
end
